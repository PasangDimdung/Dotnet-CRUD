...
namespace EmployeeManagement.Models
{
    ...
    public class MockEmployeeRepository : IEmployeeRepository
    {
        ...
        public MockEmployeeRepository()
        {
            ...
            {
                new Employee() { Id= 1, Name = "Amano Hina", Email = "amanohina@gmail.com", Department = "IT"},
                new Employee() { Id= 2, Name = "Nishimiya", Email = "nishimiya@gmail.com", Department = "HR" },
                new Employee() { Id= 3, Name = "Hodaka Morishima", Email = "hodakamorishima@gmail.com", Department = "IT" },
